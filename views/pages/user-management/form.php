                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-2 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="code" name="code" value="<?php echo htmlspecialchars(isset($_SESSION['old']['code']) ? $_SESSION['old']['code'] : (isset($data['user']['code']) ? $data['user']['code'] : '')); ?>" required>                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-2 mb-2">
                                <div class="form-group">
                                    <label for="username" class="required"><?php echo t('user_management.username'); ?></label>
                                    <input type="text" class="form-control form-control-sm" id="username" name="username" value="<?php echo htmlspecialchars(isset($_SESSION['old']['username']) ? $_SESSION['old']['username'] : (isset($data['user']['username']) ? $data['user']['username'] : '')); ?>" required>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-2 mb-2">
                                <div class="form-group">
                                    <label for="password" <?php echo $data['action'] === 'create' ? 'class="required"' : ''; ?>><?php echo t('user_management.password'); ?></label>
                                    <input type="password" class="form-control form-control-sm" id="password" name="password" <?php echo $data['action'] === 'create' ? 'required' : ''; ?> >
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 mb-2">
                                <div class="form-group">
                                    <label for="name"><?php echo t('user_management.full_name'); ?></label>
                                    <input type="text" class="form-control form-control-sm" id="name" name="name" value="<?php echo htmlspecialchars(isset($_SESSION['old']['name']) ? $_SESSION['old']['name'] : (isset($data['user']['name']) ? $data['user']['name'] : '')); ?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-2 mb-2">
                                <div class="form-group">
                                    <label for="tel"><?php echo t('user_management.phone'); ?></label>
                                    <input type="text" class="form-control form-control-sm" id="tel" name="tel" value="<?php echo htmlspecialchars(isset($_SESSION['old']['tel']) ? $_SESSION['old']['tel'] : (isset($data['user']['tel']) ? $data['user']['tel'] : '')); ?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-2 mb-2">
                                <div class="form-group">
                                    <label for="birthday"><?php echo t('user_management.birthday'); ?></label>
                                    <input type="date" class="form-control form-control-sm" id="birthday" name="birthday" value="<?php echo htmlspecialchars(isset($_SESSION['old']['birthday']) ? $_SESSION['old']['birthday'] : (isset($data['user']['birthday']) ? $data['user']['birthday'] : '')); ?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 mb-2">
                                <div class="form-group">
                                    <label for="facebook_name"><?php echo t('user_management.facebook'); ?></label>
                                    <input type="text" class="form-control form-control-sm" id="facebook_name" name="facebook_name" value="<?php echo htmlspecialchars(isset($_SESSION['old']['facebook_name']) ? $_SESSION['old']['facebook_name'] : (isset($data['user']['facebook_name']) ? $data['user']['facebook_name'] : '')); ?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-2 mb-2">
                                <div class="form-group">
                                    <label for="line_id"><?php echo t('user_management.line_id'); ?></label>
                                    <input type="text" class="form-control form-control-sm" id="line_id" name="line_id" value="<?php echo htmlspecialchars(isset($_SESSION['old']['line_id']) ? $_SESSION['old']['line_id'] : (isset($data['user']['line_id']) ? $data['user']['line_id'] : '')); ?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-2 mb-2">
                                <div class="form-group">
                                        ...
                                        <div class="image-preview-container flex-shrink-0" style="width: 90px; height: 90px; border: 1px solid #dee2e6; border-radius: 0.5rem; background: #f8f9fa; display: flex; align-items: center; justify-content: center;">
                                            <div class="image-preview w-100 h-100 d-flex align-items-center justify-content-center" id="imagePreview">
                                                <?php if (isset($data['user']['img']) && !empty($data['user']['img'])): ?>
                                                    <img src="<?php echo htmlspecialchars($data['user']['img']); ?>" alt="Preview" class="img-fluid rounded" style="max-width: 80px; max-height: 80px;">
                                                <?php else: ?>
    ...
    function previewImage(event) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                preview.innerHTML = '<img src="' + e.target.result + '" alt="Preview" class="img-fluid rounded" style="max-width: 80px; max-height: 80px;">';
            }
