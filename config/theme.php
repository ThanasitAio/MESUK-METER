...
return [
    ...
    'alternative_themes' => [
        'blue_theme' => [
            ...
            'nav_active_border_color' => 'rgba(0, 123, 255, 0.3)',
        ],
        'red_theme' => [
            'primary' => '#dc3545',
            'primary-dark' => '#c82333',
            'accent' => '#f8d7da',
            'accent-dark' => '#f5c6cb',
            'nav_active_border' => '#dc3545',
            'nav_active_border_color' => 'rgba(220, 53, 69, 0.3)',
        ],
        'purple_theme' => [
            'primary' => '#6f42c1',
            'primary-dark' => '#5a2d91',
            'accent' => '#e2d9f3',
            'accent-dark' => '#d1c7e3',
            'nav_active_border' => '#6f42c1',
            'nav_active_border_color' => 'rgba(111, 66, 193, 0.3)',
        ],
    ],
];
?>